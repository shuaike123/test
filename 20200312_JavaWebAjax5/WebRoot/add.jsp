          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="lyear_ui_icons.html">增加</a> </li>
                <li> <a href="user?method=showUsers">显示</a> </li>
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 用户 - 增加 </span>
          </div>
    ...
    <main class="lyear-layout-content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>增加用户信息</h4></div>
              <div class="card-body">
                	<!-- 显示修改的表单 -->
                	<form action="user?method=addUser2" method="post" >
	                 <div class="form-group">
	                   <label for="example-nf-username">用户名</label>
	                   <input class="form-control" type="text" id="example-nf-username" name="username" >
	                 </div>
	                 <div class="form-group">
