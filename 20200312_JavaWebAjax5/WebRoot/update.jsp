          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                <li> <a href="lyear_ui_icons.html">增加</a> </li>
      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 用户 - 修改 </span>
          </div>
    ...
    <main class="lyear-layout-content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>修改用户信息</h4></div>
              <div class="card-body">
                	<!-- 显示修改的表单 -->
                	<form action="user?method=updateUser" method="post" >
	                 <div class="form-group">
	                   <label for="example-nf-id">编号</label>
	                   <input class="form-control" type="text" value="${user.id }" readonly="readonly" id="example-nf-id" name="id" >
	                 </div>
	                 <div class="form-group">
	                   <label for="example-nf-username">用户名</label>
	                   <input class="form-control" type="text" value="${user.username }" id="example-nf-username" name="username" >
	                 </div>
	                 <div class="form-group">
	                   <label for="example-nf-password">密码</label>
	                   <input class="form-control" type="text" value="${user.password }" id="example-nf-password" name="password" >
	                 </div>
	                 <div class="form-group">
